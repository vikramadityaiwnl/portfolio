        ...
        <div className="flex justify-center gap-8">
          {socialLinks.map((link) => (
            <a
              ...
              className="p-4 bg-[#1A1B1E]/50 rounded-xl border border-gray-800 hover:border-[#007CF0] transition-all duration-300"
            >
              <link.icon className="w-8 h-8 text-[#00DFD8] stroke-[1.5]" />
            </a>
          ))}
        </div>
      </div>
